...
inline CancelableTask* NewRunnableMethod(T* object, Method method,
  ...
  return new RunnableMethod<T,
                            Method,
                            Tuple9<A, B, C, D, E, F, G, H, I> >(object,
                                                                method,
                                                                MakeTuple(a, b,
                                                                          c, d,
                                                                          e, f,
...
inline CancelableTask* NewRunnableMethod(T* object, Method method,
  ...
  return new RunnableMethod<T,
    ...
    object, method, MakeTuple(a, b, c, d, e, f, g, h, i, j));
}
...
inline Task* NewRunnableFunction(Function function, const A& a, const B& b,
  ...
  return new RunnableFunction<Function, Tuple9<A, B, C, D, E, F, G, H, I> >(
      function, MakeTuple(a, b, c, d, e, f, g, h, i));
}
...
inline Task* NewRunnableFunction(Function function, const A& a, const B& b,
                                 ...
                                 const G& g, const H& h, const I& i,
                                 const J&j) {
  return new RunnableFunction<Function, Tuple10<A, B, C, D, E, F, G, H, I, J> >(
      function, MakeTuple(a, b, c, d, e, f, g, h, i, j));
}
