...
struct Tuple9 {
 public:
  ...
  Tuple9() {}
  Tuple9(typename TupleTraits<A>::ParamType a,
    typename TupleTraits<B>::ParamType b,
    typename TupleTraits<C>::ParamType c,
    typename TupleTraits<D>::ParamType d,
    typename TupleTraits<E>::ParamType e,
...
struct Tuple10 {
 public:
  ...
  Tuple10() {}
  Tuple10(typename TupleTraits<A>::ParamType a,
    typename TupleTraits<B>::ParamType b,
    typename TupleTraits<C>::ParamType c,
    typename TupleTraits<D>::ParamType d,
    typename TupleTraits<E>::ParamType e,
...
template <class A, class B, class C, class D, class E, class F, class G,
          class H, class I>
inline Tuple9<A, B, C, D, E, F, G, H, I> MakeTuple(const A& a, const B& b,
                                                   const C& c, const D& d,
                                                   const E& e, const F& f,
                                                   const G& g, const H& h,
                                                   const I& i) {
...
template <class A, class B, class C, class D, class E, class F, class G,
          class H, class I, class J>
inline Tuple10<A, B, C, D, E, F, G, H, I, J> MakeTuple(const A& a, const B& b,
                                                       const C& c, const D& d,
                                                       const E& e, const F& f,
                                                       const G& g, const H& h,
                                                       const I& i, const J& j) {
  return Tuple10<A, B, C, D, E, F, G, H, I, J>(a, b, c, d, e, f, g, h, i, j);
}
...
inline void DispatchToMethod(ObjT* obj, Method method,
                             const Tuple9<A, B, C, D, E, F, G, H, I>& arg) {
  (obj->*method)(arg.a, arg.b, arg.c, arg.d, arg.e, arg.f, arg.g, arg.h, arg.i);
}

template<class ObjT, class Method, class A, class B, class C, class D, class E,
         class F, class G, class H, class I, class J>
inline void DispatchToMethod(ObjT* obj, Method method,
                             const Tuple10<A, B, C, D, E, F, G, H, I, J>& arg) {
  (obj->*method)(arg.a, arg.b, arg.c, arg.d, arg.e, arg.f, arg.g, arg.h, arg.i,
                 arg.j);
}
...
inline void DispatchToFunction(Function function,
                               const Tuple9<A, B, C, D, E, F, G, H, I>& arg) {
  (*function)(arg.a, arg.b, arg.c, arg.d, arg.e, arg.f, arg.g, arg.h, arg.i);
}

template<class Function, class A, class B, class C, class D, class E, class F,
         class G, class H, class I, class J>
inline void DispatchToFunction(
    Function function, const Tuple10<A, B, C, D, E, F, G, H, I, J>& arg) {
  (*function)(arg.a, arg.b, arg.c, arg.d, arg.e, arg.f, arg.g, arg.h, arg.i,
              arg.j);
}
